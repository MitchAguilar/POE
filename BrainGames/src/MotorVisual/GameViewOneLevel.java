...
import MotorLogico.Hilos.HiloEasyLevel;
 ...
 * @author mitch
 */
public class GameViewOneLevel implements MouseMotionListener, MouseListener {
    ...
    public void Comp() {
        ...
        init.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ht = new HiloTemporizador(segundos, GameViewOneLevel.this, new EasyCore(num1, num2, num3, num4, num5, Lnum1, Lnum2, Lnum3, Lnum4, Lnum5));
                ht.start();
...
//valores a escoger
    ...
    public void Frm() {
        ...
        Meives.Imagen img = new Meives.Imagen("/Complements/Img/6.jpg", fr.getWidth(), fr.getHeight());
        fr.add(img);
